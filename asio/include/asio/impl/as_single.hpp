...
#ifndef ASIO_IMPL_AS_SINGLE_HPP
#define ASIO_IMPL_AS_SINGLE_HPP
...
struct async_result<as_single_t<CompletionToken>, Signature>
{
  typedef typename async_result<CompletionToken,
    typename detail::as_single_signature<Signature>::type>
...
struct associated_executor<detail::as_single_handler<Handler>, Executor>
{
  typedef typename associated_executor<Handler, Executor>::type type;

  static type get(
      const detail::as_single_handler<Handler>& h,
...
struct associated_allocator<detail::as_single_handler<Handler>, Allocator>
{
