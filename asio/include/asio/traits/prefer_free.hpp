...
template <typename T, typename Property>
struct prefer_free_trait<T, const Property> :
  traits::prefer_free<T, Property>
{
};
...
template <typename T, typename Property>
struct prefer_free_trait<const T, Property> :
  traits::prefer_free<T, Property>
{
};

template <typename T, typename Property>
struct prefer_free_trait<const T, const Property> :
  traits::prefer_free<T, Property>
{
};
