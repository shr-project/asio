...
template <typename T, typename Property>
struct require_concept_member_trait<T, const Property> :
  traits::require_concept_member<T, Property>
{
};
...
template <typename T, typename Property>
struct require_concept_member_trait<const T, Property> :
  traits::require_concept_member<T, Property>
{
};

template <typename T, typename Property>
struct require_concept_member_trait<const T, const Property> :
  traits::require_concept_member<T, Property>
{
};
